...
func (r *K8sResourceClonerReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	memcached := &cachev1alpha1.K8sResourceCloner{}
...
func (r *K8sResourceClonerReconciler) deploymentForMemcached(m *cachev1alpha1.K8sResourceCloner) *appsv1.Deployment {
